...
public class floorCollision : MonoBehaviour
{
    ...
    [SerializeField]
    private Text azulColisionPiso; // delete
    [SerializeField]
    private Text rojoColisionPiso; // delete
    [SerializeField]
    private GameObject prefabBlueDiamond; // delete

    public int numberOfDiamondBlueCollisionsWithTheFloor = 0;
    public int numberOfDiamondRedCollisionsWithTheFloor = 0;

    private void OnTriggerEnter2D(Collider2D diamond)
    {
        if (diamond.gameObject.CompareTag("blueDiamond"))
        {
            numberOfDiamondBlueCollisionsWithTheFloor++;
        ...
        {
            numberOfDiamondRedCollisionsWithTheFloor++;
